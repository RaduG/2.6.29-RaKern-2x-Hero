cmd_scripts/mod/file2alias.o := gcc -Wp,-MD,scripts/mod/.file2alias.o.d -Wall -Wstrict-prototypes -O5 -fomit-frame-pointer     -c -o scripts/mod/file2alias.o scripts/mod/file2alias.c
