cmd_scripts/mod/modpost.o := gcc -Wp,-MD,scripts/mod/.modpost.o.d -Wall -Wstrict-prototypes -O5 -fomit-frame-pointer     -c -o scripts/mod/modpost.o scripts/mod/modpost.c
